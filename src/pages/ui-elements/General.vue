    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <CustomTab>
          ...
          <li slot="nav" class="pull-right"><a href="#"
              class="text-muted"><i class="fa fa-gear"></i></a></li>


          <div slot="content" class="active" id="tab_1" title="Tab 1">
            <b>How to use:</b>
